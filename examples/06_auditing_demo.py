...
lg1.stdout(json.dumps(SmartLogger.audit_handler_info(), indent = 4))

lg1.stdout("\nDisabling auditing...")
SmartLogger.terminate_auditing()
lg1.stdout("Auditing disabled.")
